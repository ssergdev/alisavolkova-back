# Generated by Django 3.0.6 on 2020-06-05 05:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordering', models.PositiveIntegerField(
                    default=0, verbose_name='Ordering')),
                ('tags', models.ManyToManyField(blank=True, to='merch.Tag')),
            ],
            options={
                'ordering': ['ordering'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='merch.Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True,
                                                                on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='merch.Tag')),
            ],
            options={
                'verbose_name': 'tag Translation',
                'db_table': 'merch_tag_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True,
                                                                on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='merch.Product')),
            ],
            options={
                'verbose_name': 'product Translation',
                'db_table': 'merch_product_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
                'unique_together': {('language_code', 'master')},
